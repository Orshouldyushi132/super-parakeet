...
- 見た目設定: テーマ、色、光り方、アニメーション、強さ、速さをUIから変更可能

## 調整できる表現

- テーマプリセット: モノクロフラッシュ、アイスブルー、サンセット、エメラルド、マゼンタネオン、ゴールドスパーク
- 光り方: なし、ソフト、ネオン、オーラ、輪郭、シャドウ、プリズム
- アニメーション: なし、パルス、ブレス、シマー、バウンス、エクスパンド、フリッカー、ウェーブ
...
3. 右側の見た目設定で、テーマや色、発光スタイル、アニメーションを調整します。
